...
var arrow_left = document.querySelector('.slider__arrow-left');
var arrow_right = document.querySelector('.slider__arrow-right');
var slider_faces = document.querySelectorAll('.twarz');
var middleFaceIndex = Math.floor(slider_faces.length / 2);
