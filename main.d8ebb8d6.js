...
var main = document.querySelector('.faces');
var nav = document.querySelector('nav');
faces.forEach(function (face) {
  return face.addEventListener('click', function (_ref) {
    var target = _ref.target;
    var type = getTypeOfFace(target);
...
var getTypeOfFace = function getTypeOfFace(face) {
  return face.dataset.face;
};

var getPopupClassName = function getPopupClassName(type) {
  return "popup--".concat(type);
};
